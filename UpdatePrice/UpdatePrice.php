...
<body style="background-image: url(Images/Background2.jpg); background-repeat: repeat;">
	...
	if(isset($_POST["Submit"])){
		...
		$id=$_POST["id"];
		$price=$_POST["price"];
		$sql="update provide set price='".$price."' where iid='".$id."' and hid='".$hid."'";
      ...
      echo "<hr><br>";
		...
		if(mysqli_num_rows($result1)>0){
			...
			while($row1=mysqli_fetch_assoc($result1)){
			    echo "<form method='POST' action='UpdatePrice.php'>";
				    echo "<div class='hotel'>";
				      	echo "<p>ID:</p><input type='text' name='id' value='".$row1["iid"]."' readonly><br>";
				      	echo "<p>Name:</p><input type='text' name='iname' value='".$row1["iname"]."' readonly><br>";
				      	echo "<p>Current Price: </p><input type='text' name='price' value='".$row1["price"]."'readonly>";
				      	echo "<p>New Price: </p><input type='text' name='price' placeholder='Enter new price' required>";
			...
			while($row2=mysqli_fetch_assoc($result2)){
			    echo "<form method='POST' action='UpdatePrice.php'>";
				    echo "<div class='hotel'>";
				      	...
				      	echo "<p>Name:</p><input type='text' name='iname' value='".$row2["iname"]."' readonly><br>";
			...
			while($row3=mysqli_fetch_assoc($result3)){
			    echo "<form method='POST' action='UpdatePrice.php'>";
				    echo "<div class='hotel'>";
				      	...
				      	echo "<p>Name:</p><input type='text' name='iname' value='".$row3["iname"]."' readonly><br>";
			...
			while($row4=mysqli_fetch_assoc($result4)){
			    echo "<form method='POST' action='UpdatePrice.php'>";
				    echo "<div class='hotel'>";
				      	...
				      	echo "<p>Name:</p><input type='text' name='iname' value='".$row4["iname"]."' readonly><br>";
			...
			while($row5=mysqli_fetch_assoc($result5)){
			    echo "<form method='POST' action='UpdatePrice.php'>";
				    echo "<div class='hotel'>";
				      	...
				      	echo "<p>Name:</p><input type='text' name='iname' value='".$row5["iname"]."' readonly><br>";
			...
			while($row6=mysqli_fetch_assoc($result6)){
			    echo "<form method='POST' action='UpdatePrice.php'>";
				    echo "<div class='hotel'>";
				      	...
				      	echo "<p>Name:</p><input type='text' name='iname' value='".$row6["iname"]."' readonly><br>";
			...
			while($row7=mysqli_fetch_assoc($result7)){
			    echo "<form method='POST' action='UpdatePrice.php'>";
				    echo "<div class='hotel'>";
				      	...
				      	echo "<p>Name:</p><input type='text' name='iname' value='".$row7["iname"]."' readonly><br>";
